...
vi.mock("../time-tracking/sidebar-timer-indicator", () => ({
  SidebarTimerIndicator: () => null,
}));
...
vi.mock("@multica/core/paths", () => ({
  ...
  useWorkspacePaths: () => ({
    ...
    timeTracking: () => "/acme/time-tracking",
    issues: () => "/acme/issues",
...
describe("PinRow", () => {
  ...
  it("renders loaded details", async () => {
    ...
    render(<AppSidebar />);
    expect(
      await screen.findByText("MUL-123 Keep this pin"),
    ).toBeInTheDocument();
  });
});
