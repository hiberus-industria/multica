          ...
          <div className="grid grid-cols-[auto_1fr] gap-x-2 gap-y-0.5 pl-2">
            ...
            {OPTIONAL_PROP_KEYS.some((k) => !visibleOptionalProps.has(k)) && (
              <div className="col-span-2 mt-1">
                ...
                >
                  <PopoverTrigger className="flex items-center gap-1.5 rounded-md px-2 py-1 -mx-2 text-xs text-muted-foreground hover:bg-accent/50 hover:text-foreground transition-colors">
