      ...
      <div className="flex flex-1 min-h-0 flex-col items-center justify-center gap-3 text-muted-foreground">
        ...
        <Button
          ...
          onClick={() =>
            useModalStore
              .getState()
              .open("create-issue", { project_id: projectId })
          }
        >
  ...
  return (
    <>
      ...
      <ProjectIssuesContent
        ...
        assigneeGroups={
          usesAssigneeBoard ? assigneeGroupsQuery.data?.groups : undefined
        }
        assigneeGroupQueryKey={
          usesAssigneeBoard ? assigneeGroupsOptions.queryKey : undefined
        }
        assigneeGroupFilter={
          usesAssigneeBoard ? assigneeGroupFilter : undefined
        }
        scope={scope}
        filter={filter}
    ...
    <div className="space-y-5">
          ...
          return (
            <div>
              ...
              >
                ...
                <ChevronRight
                  className={`!size-3 shrink-0 stroke-[2.5] text-muted-foreground transition-transform ${progressOpen ? "rotate-90" : ""}`}
                />
              </button>
              {progressOpen && (
      ...
      <div>
        ...
        >
          ...
          <ChevronRight
            className={`!size-3 shrink-0 stroke-[2.5] text-muted-foreground transition-transform ${descriptionOpen ? "rotate-90" : ""}`}
          />
        </button>
        {descriptionOpen && (
          <div className="pl-2">
