...
export function createEsDict(allowSignup: boolean): LandingDict {
  return {
    ...
    hero: {
      ...
      imageAlt:
        "Vista tablero de Multica — incidencias gestionadas por humanos y agentes",
    },
    ...
    features: {
      ...
      skills: {
        label: "HABILIDADES",
        title:
          "Cada solución se convierte en una habilidad reutilizable para todo el equipo",
        description:
    ...
    faq: {
      ...
      items: [
        ...
        {
          question:
            "¿Pueden los agentes trabajar en tareas largas de forma autónoma?",
          answer:
        ...
        {
          question:
            "¿Está seguro mi código? ¿Dónde ocurre la ejecución del agente?",
          answer:
      ...
      entries: [
        {
          ...
          date: "2026-05-06",
          title:
            "Lanzamiento completo de i18n, Timeline de incidencias largas y alternancia de notificaciones del sistema",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-05-03",
          title:
            "Repo Checkout `--ref`, Corrección de reproducción de Hermes y selector de modelo multi-réplica",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-30",
          title:
            "Revisión de Captura Rápida, diagramas Mermaid y recursos de proyecto tipados",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-29",
          title:
            "Crear incidencia por agente, Presencia del agente v3 y latido WebSocket del daemon",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-28",
          title:
            "Runtime Kiro CLI, notificaciones Desktop y filtro de etiquetas de incidencias",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-27",
          title:
            "Etiquetas de incidencias, pestaña Labs y punto de invitación en la barra lateral",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-26",
          title:
            "Entorno personalizado del agente, mejores mensajes de fallo y correcciones de fiabilidad",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-24",
          title:
            "Chat V2, menú contextual de incidencias con clic derecho y comentarios dentro de la app",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-22",
          title:
            "Habilidades locales, LaTeX, Modo Focus y recuperación de tareas huérfanas",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-21",
          title:
            "Empaquetado Desktop multiplataforma, autoactualización CLI y paginación del tablero",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-20",
          title:
            "Modelos por agente, runtime Kimi y autenticación de auto-hospedaje",
          changes: [],
          features: [
        ...
        },
        {
          ...
          date: "2026-04-18",
          title:
            "Subincidencias desde el editor, control de auto-hospedaje y MCP",
          changes: [],
          features: [
    ...
    download: {
      hero: {
        ...
        archFallbackHint:
          "¿Arquitectura incorrecta? Consulta todos los formatos a continuación.",
      },
      allPlatforms: {
